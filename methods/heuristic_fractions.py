...
class HeuristicFraction(Method[None, None, None, None]):
    ...
    def parameter_options(cls) -> Generator[MethodParams, None, None]:
        for target in [0.01, 0.05, 0.075, 0.1, 0.2]:
    ...
    def compute(
        ...
        return LogEntry(
            KEY=cls.KEY, safe_to_stop=1 not in last_labels, num_to_stop=num_to_stop, fraction=fraction, confidence_level=None, score=None, recall_target=None
        )
