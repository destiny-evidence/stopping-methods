...
from shared.method import Method, _MethodParams, _LogEntry, WINDOW_SIZES
...
class Knee(Method[None, None, None, None]):
    KEY: str = 'KNEE'
    ...
    def compute(
        ...
        window_size_ = min(window_size, len(labels))
        ...
        if DEV_MODE and (len(labels) % 200) == 0 and len(labels) > 100:
